    ...
    return (
      <div className={cn("relative inline-block", className)}>
        ...
        {removable && (
          <button
            type="button"
            className="absolute top-1 right-1 z-10 rounded-full bg-muted text-foreground hover:bg-accent hover:text-accent-foreground"
            onClick={onRemove}
    ...
    return (
      ...
      >
        ...
        {removable && (
          <button
            type="button"
            className="ml-2 self-start rounded-full bg-muted p-1 text-primary hover:bg-accent"
            onClick={onRemove}
  ...
  return (
    ...
    >
      ...
      {removable && (
        <button
          type="button"
          className="ml-2 rounded-full bg-muted p-1 text-muted-foreground hover:bg-accent"
          onClick={onRemove}
